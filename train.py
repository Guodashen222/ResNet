...
if __name__ == '__main__':
    ...
    resume = False
    CLIP_GRAD = 5.0
    model_path = '/checkpoints/mask/best.pth'
    Best_ACC = 0 #记录最高得分
    use_ema=True
    # 数据预处理7
    t = [
    ...
    transform = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.49942112, 0.45988494, 0.44343582], std=[0.20308474, 0.2090247, 0.21762154])
    ...
    dataset_train = datasets.ImageFolder('/home/guo/ResNet/Mask1.v1i.folder/train', transform=transform)
    dataset_test = datasets.ImageFolder("/home/guo/ResNet/Mask1.v1i.folder/valid", transform=transform_test)
